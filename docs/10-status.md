...
1. **M7 — Поддержка и админка:** поддержка S-31 (тикеты СП-*, категории обращений, вложения, оценка), роль/настройки S-34/S-35 (Р-*, язык), мини-веб-админка `apps/admin` (5 очередей: верификация, дипломы, категории, жалобы на отзывы, тикеты + блокировка СП-09 + аудит-лог НФ-13), отмена/спор заказа (ЗВ-06/ЗВ-07).

Дальше M8 (polish + seed + e2e) без пауз (правило работы №1 из ZOVU_PROMPT.md §11).
