...
- **Радиусы**: инпуты **12** · CTA-кнопки **14** · карточки **16–18** · чипы/пиллы **999** · bottom sheets **20** (верхние углы).
- **Высоты**: CTA-кнопки **52** · инпуты **52**.
- **Отступ экрана**: 16–20 по горизонтали.
- **Тени**: почти не используются. Карточки — `border 1px` (`#E4E6EC`/`#ECEDF1`); при необходимости еле заметная тень **максимум y2 blur8 α0.04**. Тяжёлые тени запрещены (§10).
...
- **Онбординг специалиста** (S-05…S-08): толстый закруглённый progress bar в стиле Duolingo, шаги 1–4, анимированное заполнение.
