...
| **2 — Кластер «решение о ставке»** | 🟡 частично: **2A** ✅ (скелетон-система на все экраны, таймлайн статуса заказа, карточка исполнителя + accept-в-чат, pull-to-refresh №10). **2B** ⏳ (реальные фото: галерея заказа + аватары — нужен аплоад). Карточка отклика 4-сигнальная — уже в Спринте 1 (№8). |
